 <?php
     include('includes\config.php');                      
                      ...
                      $product_query = "SELECT * FROM product where category='Family Care'";
            ...
            <div class="container" id="get_category_home">
                ...
                <div id="responsive-nav" >
                    ...
                    <li ><a href="medicine.php">Medicine</a></li>
                            ...
                            <li><a href="personalCare.php">SHJKDS</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="section-title" >
                            <h3 class="title" style="color:white">Family Care</h3>
                        ...
                        echo "
                                ...
                                <div class='product'>
                                    <a href='product.php?p=$pro_id'><div class='product-img'>
                                        <img src='./PharmacyModule/assets/images/$pro_image' style='max-height: 170px;' alt=''>
                                    ...
                                    <div class='add-to-cart'>
                                        <button pid='$pro_id' id='product' class='add-to-cart-btn block2-btn-towishlist' href='cart.php?id=<?php echo $pro_id;?>'><i class='fa fa-shopping-cart'></i> add to cart</button>
                                    </div>
                                </div>
                                 </div>
